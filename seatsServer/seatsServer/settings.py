"""
Django settings for seatsServer project.
...
SECRET_KEY = '7@(==8m6!ur!*2+8d&#m020q$09e0fevew@8mvir1%+6eczkav'
...
ROOT_URLCONF = 'seatsServer.urls'

WSGI_APPLICATION = 'seatsServer.wsgi.application'
